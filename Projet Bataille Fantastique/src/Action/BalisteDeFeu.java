...
/**
 * Cette classe représente l'action  "Baliste de Feu"
 */
public class BalisteDeFeu extends Action {
	/**
	 * Elle inflige 6 point de dégat au personnage attaqué
	 */
	...
	public static String getDescription(){
		return "<HTML><BODY>Une attaque à distance qui inflige 6  dommages à <BR>"
	...
	/**
	 * Routine de l'action de Baliste de Feu sur le personnage attaqué
